...
/**
 * Базовый класс для создания нового плагина. Полную реализацию класса смотрите в Wbcr_Factory433_Plugin
 *
 ...
 */
class  Wbcr_Factory433_Base {

	use WBCR\Factory_433\Options;
	 ...
	 * экземпляр класса \WBCR\Factory_433\Entities\Support, для получения информации о сайте плагина.
	 ...
	 * WBCR\Factory_433\Premium\Provider > WBCR\Factory_Freemius_120\Premium\Provider
	 *
	...
	/**
	 * Экземпляр класса \WBCR\Factory_433\Entities\Support используется для получения информации
	 ...
	 *
	 * @var \WBCR\Factory_433\Entities\Support
	 */
	protected $support;

	/**
	 * Экземпляр класса \WBCR\Factory_433\Entities\Paths используется для получения информации о
	 * путях плагина. Часто используется для получения путей или ссылок на место хранения плагина
	 * или его входного файла.
	 *
	 * @var \WBCR\Factory_433\Entities\Paths
	 */
	protected $paths;
	...
	public function __construct( $plugin_file, $data ) {
		...
		$this->support = new \WBCR\Factory_433\Entities\Support( $this->support_details );
		$this->paths   = new \WBCR\Factory_433\Entities\Paths( $plugin_file );
	 ...
	 * См. Wbcr_Factory433_Base::has_premium
	 */
	 ...
	 *
	 * @return string Возвращает заголовок плагина. См. Wbcr_Factory433_Base::plugin_title
	 */
	 ...
	 *
	 * @return string Возвращает префикс плагина.См. Wbcr_Factory433_Base::prefix
	 */
	 ...
	 *
	 * @return string Возвращает имя плагина. См. Wbcr_Factory433_Base::plugin_name
	 */
	 ...
	 *
	 * @return string Возвращает версию плагина. См. Wbcr_Factory433_Base::plugin_version
	 */
	 ...
	 *                            Wbcr_Factory433_Base::plugin_data
	 *
	 * @return null
	 */
	...
	/**
	 * Предоставляет доступ к экземпляру класса \WBCR\Factory_433\Entities\Support.
	 *
	 * @return \WBCR\Factory_433\Entities\Support
	 */
	...
	/**
	 * Предоставляет доступ к экземпляру класса \WBCR\Factory_433\Entities\Paths.
	 *
	 * @return \WBCR\Factory_433\Entities\Paths
	 */
	 ...
	 *
	 * @return object Возвращает объект с сырыми данными плагина. См. Wbcr_Factory433_Base::plugin_data
	 */
