...
$main_classes      = 'col-sm-9 col-lg-6';
$secondary_classes = 'col-sm-3';
?>
<div class="anwp-pg-wrap">
	<div class="d-flex row flex-wrap no-gutters anwp-pg-hero-block anwp-pg-posts-wrapper anwp-pg-gutter--<?php echo esc_attr( $data->grid_gutter ); ?>">
