...
function twentytwenty_register_scripts() {
	...
	wp_enqueue_script( 'remologie-custom-scripts', get_theme_file_uri( '/assets/js/custom-scripts.js' ), array(), '20181214', true );
...
function twentytwenty_sidebar_registration() {
	...
	register_sidebar(
		array_merge(
			$shared_args,
			array(
				'name'        => __( 'Above Footer', 'twentytwenty' ),
				'id'          => 'sidebar-3',
				'description' => __( 'Widgets in this area will be displayed above the footer.', 'twentytwenty' ),
			)
		)
	);
